...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'translations.context_processors.app_settings',
            ],
        },
    },
]
...
VIP_DAILY_LIMIT = 20
CHAR_LIMIT = 38000
GEMINI_CHUNK_MAX_CHARS = int(os.getenv("GEMINI_CHUNK_MAX_CHARS", "6500"))
MISTRAL_CHUNK_MAX_CHARS = int(os.getenv("MISTRAL_CHUNK_MAX_CHARS", "5500"))
PROVIDER_CHUNK_LIMITS = {
    'gemini': GEMINI_CHUNK_MAX_CHARS,
    'mistral': MISTRAL_CHUNK_MAX_CHARS,
}
SUBTITLE_CHUNK_MAX_CHARS = GEMINI_CHUNK_MAX_CHARS  # Default fallback
