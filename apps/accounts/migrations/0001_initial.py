    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vip_expires_at', models.DateTimeField(blank=True, null=True, verbose_name='تاریخ انقضای VIP')),
                ('daily_usage', models.IntegerField(default=0, verbose_name='استفاده روزانه')),
                ('last_usage_date', models.DateField(default=django.utils.timezone.now, verbose_name='آخرین تاریخ استفاده')),
                ('max_daily_quota', models.IntegerField(default=3, verbose_name='حداکثر سهمیه روزانه')),
